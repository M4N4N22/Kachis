        ...
        <Bento className="relative overflow-hidden p-6">
          ...
          <div className="relative">
            ...
            <p className="mt-6 break-all font-mono text-[11px] text-muted-fg">
              {wallet.address ?? copy.org.walletRequired}
            </p>
            {connected && wallet.balances ? (
              <dl className="mt-6 space-y-2">
                <div className="flex justify-between gap-3 text-[11px]">
                  ...
                  <dd className="font-mono">
                    {formatDisplayAmount(wallet.balances.unshielded)}{" "}
                    {nightAsset(wallet.network)}
                  </dd>
                </div>
                <div className="flex justify-between gap-3 text-[11px]">
                  <dt className="text-muted-fg">{copy.wallet.shielded}</dt>
                  <dd className="font-mono">
                    {formatDisplayAmount(wallet.balances.shielded)}{" "}
                    {nightAsset(wallet.network)}
                  </dd>
                </div>
                <div className="flex justify-between gap-3 text-[11px]">
              ...
              <p className="mt-6 text-[11px] text-muted-fg">
                {copy.wallet.balancesUnavailable}
              </p>
            ) : null}
          </div>
        </Bento>
