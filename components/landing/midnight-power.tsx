...
export function MidnightPower() {
  return (
    <section id="midnight" className="relative overflow-hidden bg-[#0A0A0A] py-16 text-white md:py-24">
      <div
        ...
        <div className="flex flex-col items-start gap-6 md:flex-row md:items-end md:justify-between">
          <div className="max-w-2xl">
           ...
           Powered by 
            ...
            <p className="landing-fade mt-4 max-w-xl text-[15px] leading-7 text-white/60">
          ...
          <Link
            ...
            className="landing-fade inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/5 px-4 py-2 text-[12px] font-medium text-white/80 transition-colors hover:border-white/25 hover:text-white"
          >
            midnight.network
          ...
          {PILLARS.map((pillar, index) => (
            ...
            >
              <div className="flex items-center justify-between gap-3">
                ...
                <span className="text-[11px] font-semibold tracking-wide text-white/35">
                  0{index + 1}
                </span>
              </div>
              <h3 className="mt-5 text-[1.15rem] font-medium tracking-tight text-white">
                {pillar.title}
              </h3>
              <p className="mt-2 text-[13px] leading-6 text-white/55">{pillar.body}</p>
            </article>
          ))}
        </div>
      </div>
