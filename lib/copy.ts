...
export const copy = {
  ...
  pack: {
    required:
      "Institutional workspaces must enable every filter before shield.",
    labels: {
      pii: "Identifiers",
  ...
  guardrails: {
    ...
    liveHint:
      "Institutional workspaces must enable every filter before shield. Tenant-persisted policy is later.",
  ...
  wallet: {
    ...
    viewIdentity: "Open Infrastructure",
  },
  analytics: {
    ...
    packs: "Filters",
    trailHint:
      "Open Audit Trail for chronological settlements, commitment hashes, and policy flags.",
  },
  audits: {
  ...
  nav: {
    ...
    manageOrg: "Manage in Infrastructure",
  },
  org: {
    title: "Organization",
    helper:
  ...
  providers: {
    ...
    helper:
      "Bring-your-own credentials stay in local environment variables. They never enter the public log.",
    openai: "OpenAI",
    anthropic: "Anthropic",
    gemini: "Gemini",
